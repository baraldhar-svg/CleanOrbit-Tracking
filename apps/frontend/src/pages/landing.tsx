...
export default function Landing() {
  ...
  return (
    <div className="relative flex min-h-[100dvh] flex-col overflow-y-scroll bg-[#0F172A] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-slate-900 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-slate-700 hover:[&::-webkit-scrollbar-thumb]:bg-amber-500">
      ...
      {/* ── Floating Sticky WhatsApp Button (Get More) ──────────────────── */}
      <a
        href="https://wa.me/9779747468885"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed right-3 sm:right-5 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center gap-1 rounded-2xl bg-gradient-to-b from-emerald-500 to-green-600 hover:from-emerald-400 hover:to-green-500 text-white p-2.5 shadow-2xl shadow-emerald-950/80 border border-emerald-300/40 transition-all hover:scale-110 active:scale-95 group backdrop-blur-md"
